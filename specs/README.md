...
The retained formal evidence checks 59 bounded model cases (including required negative
controls) and 48 inductive obligations. The composition argument states the assumptions
