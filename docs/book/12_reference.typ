...
#table(columns: (1.4fr, 1.6fr),
  ...
  [Queued output], [64 frames and at most 2 MiB per connection.],
  [Consensus window], [64 active slots, reused only after safe floor advancement.],
  [Application/journal grouping], [At most 16 requests/transitions per group.],
...
#table(columns: (1fr, 2fr),
  ...
  [Read marker], [A fresh ordered value used to authorize a read snapshot.],
