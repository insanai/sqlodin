...
6.8–40.6% of SQLite; the absolute gain is 1.9–10.5× per case. On three separate hosts, 32-client
pure writes rose from 95 to 784 per second (medians), and a sequential fresh read fell from 44.6 to
0.51 ms.
