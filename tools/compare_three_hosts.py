...
out["writes_24_per_s"] = burst(24, 25, 0)
out["mixed70_24_per_s"] = burst(24, 30, 70)
for node in (1, 2, 3):
...
def sample(args, binary, stamp):
    with tempfile.TemporaryDirectory(prefix='sqlodin-three-host-') as work:
        ...
        try:
            ...
            result = subprocess.run([*SSH, args.client, f'python3 {remote}/worker.py {remote} {args.client_python_src}'],
